...
TEST_CASE("LinkCollection basics", "[links]") {
  STATIC_REQUIRE(podio::typeName<TestL> == "podio::Link<ExampleHit,ExampleCluster>");
  STATIC_REQUIRE(podio::typeName<TestLColl> == "podio::LinkCollection<ExampleHit,ExampleCluster>");
